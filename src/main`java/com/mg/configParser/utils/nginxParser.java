...
public class nginxParser extends parser{
    ...
    public void parsenginx(File target){
	    ...
	    */
	    ...
	    this.r.insert("process owner",root.findValue("user"));
	    ...
	    for(confNode cn : arr_node){
		    ...
		    if(check_ext){
			    ...
			    if(rt!=null){
				    ...
				    r.insert("ext permission","\t"+rt+"\n");
			    }
			    if(deny!=null){
				    System.out.println("\t\t\tdeny "+deny);
				    r.insert("ext permission","\t"+deny);
			    }
			    System.out.println("\t\t}");
		    }
	    }
